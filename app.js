...
var x = setInterval(function() {
  ...
  document.getElementById("whatsapp").innerHTML =
        "<img width='25px' height='25px' src='wp.png'/><a style='color:red'; href='whatsapp://send?text=Touch this blue line enter your name and see magic 👉 https://year2020wishes.herokuapp.com?from="+name+"'>Create Wish with your name</a><img width='25px' height='25px' src='wp.png'/>";
